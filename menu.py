...
class Boton(pygame.sprite.Sprite):
    def __init__(self,imagen1,imagen2,x=300,y=450):
        ...
        self.sonido = pygame.mixer.Sound("menu/grabacion.ogg")
...
jugar1=pygame.image.load("menu/boton1.png")
jugar2=pygame.image.load("menu/boton2.png")
puntaje1=pygame.image.load("menu/puntaje1.png")
puntaje2=pygame.image.load("menu/puntaje2.png")
...
pygame.mixer.music.load("menu/fondo.mp3") #Carga de mp3 sonido de fondo
